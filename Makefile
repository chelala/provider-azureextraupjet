...
PROJECT_NAME ?= provider-azureextraupjet
PROJECT_REPO ?= github.com/chelala/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 3.94.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-azurerm
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-azurerm_v3.94.0
...
xpkg.build.provider-azureextraupjet: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/azureextraupjets/01-delete.yaml.tmpl.
